...
<head>
    ...
    <link rel="icon" href="#">
    <title>My Orders || UKMDineDash Food Order System</title>
                        ...
                        <div class="bg-gray">
                            <div class="row">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php 
						                $query_res= mysqli_query($db,"select * from ukmdinedash_users_orders where u_id='".$_SESSION['user_id']."'");
												if(!mysqli_num_rows($query_res) > 0 )
														{
															echo '<td colspan="6"><center>You have no order placed yet. </center></td>';
														}
													else
														{			      
                                        ...
                                        <tr>
                                            ...
                                            <td data-column="Stall"><?php echo $row['stall_name']; ?></td>
                                            <td data-column="College"><?php echo $row['college_name']; ?></td>
                                            <td data-column="status">
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                        ?>
                                                <button type="button" class="btn btn-success"><span class="fa fa-check-circle" aria-hidden="true"></span>Order Completed</button>
                                                <?php 
													} 
														?>
                                                <?php
