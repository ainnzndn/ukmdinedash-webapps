...
<head>
    ...
    <link rel="icon" href="#">
    <title>Colleges || UKMDineDash Food Order System</title>
...
while ($rows = mysqli_fetch_array($ress)) {
    echo '<div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
        <div class="entry-logo">
            <a class="img-fluid" href="stalls.php?college_id=' . $rows['college_id'] . '"> <img src="admin/college_img/' . $rows['college_image'] . '" alt="College Image"></a>
        </div>
        <!-- end:Logo -->
        <div class="entry-dscr">
            <h5><a href="stalls.php?college_id=' . $rows['college_id'] . '">' . $rows['college_name'] . '</a></h5>
        </div>
    ...
    <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
        <div class="right-content bg-white">
            <div class="right-review">
                <a href="stalls.php?college_id=' . $rows['college_id'] . '" class="btn btn-purple">View College</a>
            </div>
        </div>
        <!-- end:right info -->
    </div>';
