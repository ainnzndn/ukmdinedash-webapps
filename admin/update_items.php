...
if(isset($_POST['submit']))
{
    ...
    else
    {
        ...
        {        
            ...
            {
                $sql = "UPDATE ukmdinedash_items SET stall_id='$_POST[stall_name]', title='$_POST[item_name]', price='$_POST[price]', img='$fnew', college_id='$_POST[college_name]' WHERE itm_id='$_GET[item_update]'";
                mysqli_query($db, $sql); 
                    ...
                    <hr>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Stalls</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_stall.php">Add Stall</a></li>
                            </ul>
                        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="item_name" value="<?php echo $roww['title'];?>" class="form-control" placeholder="Morzirella">
                                        </div>
                                    </div>
                                </div>
