...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || UKMDineDash Food Order System</title>
...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/img/pimg3.png">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Order Dine In or Takeout </h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4 style="color: white; font-weight: bold;">1. Choose College and Stall</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4 style="color: white; font-weight: bold;">2. Order Food</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4 style="color: white; font-weight: bold;">3. Dine In or Takeout</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="title text-xs-center m-b-30">
        <h2>Popular Stalls of the Month</h2>
        <p class="lead">Easiest way to order your favourite food among these top 6 stalls</p>
    </div>
    <div class="row">
        <?php
        $query_res = mysqli_query($db, "SELECT stalls.*, colleges.college_name FROM ukmdinedash_stalls AS stalls INNER JOIN ukmdinedash_colleges AS colleges ON stalls.college_id = colleges.college_id ORDER BY RAND() LIMIT 6"); 
        while($r = mysqli_fetch_array($query_res)) {
            $img_src = 'images/stall_img/' . $r['image'];
            echo '<div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        <div class="figure-wrap bg-image" data-image-src="'.$img_src.'"></div>
                        <div class="content">
                            <h5><a href="items.php?res_id='.$r['stall_id'].'">'.$r['stall_name'].'</a></h5>
                            <div class="price-btn-block">
                                <span class="college">'.$r['college_name'].'</span>
                                <a href="items.php?res_id='.$r['stall_id'].'" class="btn theme-btn-dash pull-right">Browse Now</a>
                            </div>
                        </div>
                    </div>
                </div>';
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="restaurant-listing">
                    <?php  
                        $ress = mysqli_query($db, "SELECT * FROM ukmdinedash_colleges");  
                        while ($rows = mysqli_fetch_array($ress)) {
                            $query = mysqli_query($db, "SELECT * FROM ukmdinedash_colleges WHERE college_id='".$rows['college_id']."' ");
                            $rowss = mysqli_fetch_array($query);
                            echo '
                            <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all '.$rows['college_name'].'">
                                <a href="stalls.php?college_id='.$rows['college_id'].'" style="text-decoration: none;">
                                    <div class="restaurant-wrap">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                                <div class="restaurant-logo">
                                                    <img src="admin/college_img/'.$rows['college_image'].'" alt="College Image">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                                <h4 style="font-weight: 600; color: black;">'.$rows['college_name'].'</h4>
                                            </div>
                                        </div>
                                    </div>
                                </a>
